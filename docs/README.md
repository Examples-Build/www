...
Before starting our development, we'll require to setup our Prisma Migrations. Remix SaaS uses Prisma as its ORM, with Postgres as its default database. You can change it to any other database supported by Prisma.
